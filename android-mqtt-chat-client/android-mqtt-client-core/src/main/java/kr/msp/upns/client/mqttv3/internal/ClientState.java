...
import kr.msp.upns.client.mqttv3.MqttClientPersistence;
import kr.msp.upns.client.mqttv3.MqttException;
import kr.msp.upns.client.mqttv3.MqttMessage;
import kr.msp.upns.client.mqttv3.MqttPersistable;
import kr.msp.upns.client.mqttv3.MqttPersistenceException;
import kr.msp.upns.client.mqttv3.internal.trace.Trace;
import kr.msp.upns.client.mqttv3.internal.wire.MqttAck;
import kr.msp.upns.client.mqttv3.internal.wire.MqttConnack;
...
import kr.msp.upns.client.mqttv3.internal.wire.MqttPingResp;
import kr.msp.upns.client.mqttv3.internal.wire.MqttPubAck;
import kr.msp.upns.client.mqttv3.internal.wire.MqttPubComp;
import kr.msp.upns.client.mqttv3.internal.wire.MqttPubRec;
import kr.msp.upns.client.mqttv3.internal.wire.MqttPubRel;
...
//		System.out.println("### message.getMessageId():"+message.getMessageId());
	...
	private MqttWireMessage checkForActivity() throws MqttException {
        ...
        long ouboundMiliTime = (System.currentTimeMillis()+1000) - lastOutboundActivity;
        long inBoundMiliTime = (System.currentTimeMillis()+1000) - lastInboundActivity;

		if (ouboundMiliTime >= this.keepAlive || inBoundMiliTime >= this.keepAlive) {
