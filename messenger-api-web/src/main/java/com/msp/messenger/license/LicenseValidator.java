package com.msp.messenger.license;

import com.msp.messenger.bean.AppLicenseBean;
import com.msp.messenger.license.exception.InvalidLicenseException;
import com.msp.messenger.util.PropertiesLoader;
...
public class LicenseValidator implements ResourceLoaderAware{
    ...
    private Map<String,AppLicenseBean> appLicenseBeanMap = new HashMap<String, AppLicenseBean>();
    ...
    private LicenseValidator(){
        ...
        String liceseDirSrc = HomeSrc+"WEB-INF/classes/config/";

        this.licenseFileSrc = liceseDirSrc+"license.key";
        this.indexFileSrc = liceseDirSrc+"license.cer";
    }


    public void setLicenseFileDir(String homeDir){
    ...
    public synchronized void initialize() throws Exception {
        ...
        for(String application : applications) {
            ...
            AppLicenseBean appLicenseBean = new AppLicenseBean(application,m_licenseInfoMap.get(application+".mpsn").toString(),secretKey);
            appLicenseBeanMap.put(application,appLicenseBean);
    ...
    public boolean chkAppid(String appid){
        log.debug("#### appIdSet size : "+appIdSet.size());
    ...
    public AppLicenseBean getAppLicenseBean(String appid){
        return appLicenseBeanMap.get(appid);
    }

    public Map<String,AppLicenseBean> getAppLicenseBeanMap(){
        return appLicenseBeanMap;
    }
}
