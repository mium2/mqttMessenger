...
function makeMessageID(){
    //var msgid = $.jStorage.get(clientID+"_msgid");
    var msgid = localStorage.getItem(clientID+"messageid");
    if(msgid==null){
        msgid = 1;
        //$.jStorage.set(clientID+"_msgid",msgid);
        localStorage.setItem(clientID+"messageid",msgid);
        return msgid;
    }else{
        if(msgid>=65536){
            msgid = 1;
