...
<form method="post" action="sendtest.ctl">
...
<tr>
	...
	<td style="background:#ffffff;">
		<input type="text" name="CUID" style="width:200px;" value="cuid1" />
	</td>
</tr>
<tr>
	<td style="background:#c0c0ff;">
...
<tr>
	...
	<td style="background:#ffffff;">
		<textarea name="MESSAGE" style="width:400px; height:200px;">전송 테스트 메세지입니다.
		UPNS TEST
		1234567890
		==============
		&&&&&&&&&&&&&&
...
<tr>
	...
	<td style="background:#ffffff;">
		<input type="text" name="TYPE" style="width:200px;" value="TESTTYPE" />
	</td>
</tr>
<tr>
	<td style="background:#c0c0ff;">
...
<tr>
	...
	<td style="background:#ffffff;">
		...
		<input type="hidden" name="ISPUBLICPUSH" value="N" />
		<input type="hidden" name="SERVICECODE" value="0001" />
	</td>
</tr>
